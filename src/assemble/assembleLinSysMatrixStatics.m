function A = assembleLinSysMatrixStatics(beam, mesh, x, alpha, computeAnumerically)
...
if computeAnumerically
    ...
    for i = 1:mesh.ndofsTotal
        ...
        rhs1 = assembleGlobalResidualStatics(beam, mesh, alpha, x1);
        rhs2 = assembleGlobalResidualStatics(beam, mesh, alpha, x2);
    ...
    for e = 1:mesh.nelms
        ...
        A22(dofseInd,dofseInd)   = A22(dofseInd,dofseInd)   + elementLinConstitutiveSysMatrix(beam, mesh, e);
    end
    % employing symmetry
